...
Scrapy-паук для парсинга всех PEP-документов Python.

Функции паука:
    - Получение списка всех PEP со страницы каталога.
    - Переход по каждой ссылке на PEP и извлечение:
        - номера документа,
        - названия документа,
        - текущего статуса.

Собранные данные сохраняются в объект PepParseItem.
Логирование осуществляется через self.logger для информации и предупреждений.
"""
